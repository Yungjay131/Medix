 ...
 */
class IDHelper(private val taskManager: TaskManager) {
    ...
    fun generateNewUserIDAsync(): String {
        return taskManager.runOnSingleThread(Callable<String> { generateRandomID(12) })
    }

    fun generateNewUserID():String = generateRandomID(12)

    fun generateNewMessageIDAsync(): String {
        return taskManager.runOnSingleThread(Callable<String> { generateRandomID(15) })
    }

    fun generateNewMessageID():String = generateRandomID(15)

    fun generateRandomID(limit: Int): String {
