...
//region messages
const val NO_INTERNET_CONNECTION_MESSAGE = "You are currently not connected to the internet. Please check your connection and try again"
//endregion
...
/* for sharedPreferences storing of userDetails */
const val USER_DETAILS = "userdetails"
/* endregion */

/* properties for FBUserDetailsVModel */
const val FBU_USER_DETAILS = "userDetails"
const val FBU_ACCOUNT_TYPE = "accountType"
const val FBU_FIRST_NAME = "firstName"
const val FBU_LAST_NAME = "lastName"
const val FBU_FULL_NAME = "fullName"
const val FBU_EMAIL = "email"
const val FBU_SEX = "sex"
const val FBU_AGE = "age"
const val FBU_FIREBASE_UID = "firebaseUID"
const val FBU_AGORA_UID = "agoraUID"
const val FBU_FCM_REGISTRATION_TOKEN = "fcm_registration_token"
const val FBU_IMAGE_URI = "imageUri"
const val FBU_HISTORY = "history"
const val FBU_SPECIALIZATION = "specialization"
...
const val LOCATION_ACTIVITY_INTENT_FILTER = "app.slyworks.core_feature.LocationActivity.open"
const val VIEW_REQUESTS_ACTIVITY_INTENT_FILTER = "app.slyworks.requests_feature.main.ViewRequestsActivity.open"
