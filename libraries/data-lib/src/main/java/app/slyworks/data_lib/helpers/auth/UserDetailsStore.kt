...
class UserDetailsStore(
    ...
    private val preferenceManager: PreferenceManager) : IUserDetailsStore {
    //region Vars
    ...
    private fun saveUserDetailsToSharedPrefs(userDetails: FBUserDetailsVModel):Boolean{
        ...
        try{
            ...
            preferenceManager.set(USER_DETAILS, encryptedDPDetailsJson)
    ...
    private fun getUserDetailsFromSharedPrefs():FBUserDetailsVModel?{
        ...
        try {
            val _userDetailsString:String? = preferenceManager.get(USER_DETAILS)
    ...
    private fun clearUserDetailsFromSharedPrefs(){
        preferenceManager.clearPreference(USER_DETAILS)
    }
}