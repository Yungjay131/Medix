...
class RVConsultationsAdapter : RecyclerView.Adapter<RVConsultationsAdapter.ViewHolder>() {
    //region Vars
    private var mList:MutableList<Consultation> = mutableListOf()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val entity:Consultation = mList.get(position) ?: return
        holder.bind(entity)
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(entity:Consultation){
            ...
            if(entity.type == ConsultationType.DOCTOR)
                tvPersonName.text = App.getContext().getString(R.string.consultation_doctor, entity.personName)
